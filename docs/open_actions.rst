...
Scripting the opening of files with alatty
-------------------------------------------------------

On macOS you can use :guilabel:`Open With` in Finder or drag and drop files and
URLs onto the alatty dock icon to open them with alatty. Similarly on Linux, you
can associate certain files types to open in alatty. The default actions are:
