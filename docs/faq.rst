...
As of version 0.40 alatty has innovated a :doc:`new protocol
...
First, be sure to `use a color scheme in vim <https://github.com/kovidgoyal/alatty/discussions/8196#discussioncomment-11739991>`__
...
The contents of the file are assumed to be the command line to pass to alatty in
...
Use the :ref:`panel kitten <quake>`, this allows you to use alatty as a quick
access Quake like terminal and even to use alatty as the desktop background, if
so desired.
...
.. image:: https://github.com/sfsam/some_icons/raw/main/alatty.app.iconset/icon_128x128@2x.png
...
You can put :file:`alatty.app.icns` (macOS only) or :file:`alatty.app.png` in the
:ref:`alatty configuration directory <confloc>`, and this icon will be applied
automatically at startup. On X11 and Wayland, this will set the icon for alatty windows.
...
.. tab:: Linux
   ...
   #. Copy :file:`alatty.desktop` from the installation location (usually
...
configuration files such as ``XDG_*``, :envvar:`ALATTY_CONFIG_DIRECTORY` and,
