...
option in :file:`alatty.conf`. You can also easily switch between sessions with
...
can use either keyboard shortcuts or the mouse scroll wheel to do so. |alatty|
