...
--------------------------------
To control alatty from outside alatty, it is necessary to setup a socket to
communicate with alatty. First, start |alatty| as::
...
file :file:`~/.config/alatty/rc-pass` to avoid having to type it repeatedly.
