...
from alatty.options.utils import DELETE_ENV_VAR, EasingFunction, to_color
from alatty.utils import log_error, shlex_split
...
def cli_parsing(self):
    from alatty.cli import CLIOptions, Options, parse_cmdline, parse_option_spec
