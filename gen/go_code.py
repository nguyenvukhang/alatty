...
from alatty.config import commented_out_default_config
...
from alatty.simple_cli_definitions import CompletionSpec, parse_option_spec, serialize_as_go_string
...
def make_bitfields() -> None:
    from alatty.fast_data_types import SCALE_BITS, SUBSCALE_BITS, WIDTH_BITS
...
def generate_completions_for_alatty() -> None:
    ...
    print('import "github.com/kovidgoyal/alatty/tools/cli"')
    print('import "github.com/kovidgoyal/alatty/tools/cmd/tool"')
    print('import "github.com/kovidgoyal/alatty/tools/cmd/at"')
...
def generate_constants() -> str:
    ...
    from alatty.colors import ThemeFile
    ...
    from alatty.simple_cli_definitions import CONFIG_HELP
...
def update_at_commands() -> None:
    ...
    code = f'''
package at
import "github.com/kovidgoyal/alatty/tools/cli"
