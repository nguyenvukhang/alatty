...
from alatty.simple_cli_definitions import serialize_as_go_string
...
def gen_go_code(defn: Definition) -> str:
    lines = ['import "fmt"', 'import "strconv"', 'import "github.com/kovidgoyal/alatty/tools/config"',
             'import "github.com/kovidgoyal/alatty/tools/utils/style"',
