...
class Options:
    active_border_color: alatty.fast_data_types.Color | None = Color(0, 255, 0)
    ...
    copy_on_select: str = ''
    cursor: alatty.fast_data_types.Color | None = Color(204, 204, 204)
    cursor_beam_thickness: float = 1.5
    cursor_blink_interval: tuple[float, alatty.options.utils.EasingFunction, alatty.options.utils.EasingFunction] = (-1.0, alatty.options.utils.EasingFunction(), alatty.options.utils.EasingFunction())
    cursor_shape: int = 1
    cursor_shape_unfocused: int = 4
    cursor_stop_blinking_after: float = 15.0
    cursor_text_color: alatty.fast_data_types.Color | None = Color(17, 17, 17)
    cursor_trail: int = 0
    cursor_trail_color: alatty.fast_data_types.Color | None = None
    ...
    selection_background: alatty.fast_data_types.Color | None = Color(255, 250, 205)
    selection_foreground: alatty.fast_data_types.Color | None = Color(0, 0, 0)
    shell: str = '.'
    ...
    tab_bar_background: alatty.fast_data_types.Color | None = None
    tab_bar_edge: int = 8
    tab_bar_filter: str = ''
    tab_bar_margin_color: alatty.fast_data_types.Color | None = None
    ...
    transparent_background_colors: tuple[tuple[alatty.fast_data_types.Color, float], ...] = ()
    ...
    url_prefixes: tuple[str, ...] = ('file', 'ftp', 'ftps', 'gemini', 'git', 'gopher', 'http', 'https', 'irc', 'ircs', 'alatty', 'mailto', 'news', 'sftp', 'ssh')
    url_style: int = 3
    visual_bell_color: alatty.fast_data_types.Color | None = None
    visual_bell_duration: tuple[float, alatty.options.utils.EasingFunction, alatty.options.utils.EasingFunction] = (0.0, alatty.options.utils.EasingFunction(), alatty.options.utils.EasingFunction())
    ...
    font_features: dict[str, tuple[alatty.fast_data_types.ParsedFontFeature, ...]] = {}
    kitten_alias: dict[str, str] = {}
    menu_map: dict[tuple[str, ...], str] = {}
    modify_font: dict[str, alatty.fonts.FontModification] = {}
    ...
    map: list[alatty.options.utils.KeyDefinition] = []
    keyboard_modes: KeyboardModeMap = {}
    alias_map: AliasMap = AliasMap()
    mouse_map: list[alatty.options.utils.MouseMapping] = []
    mousemap: MouseMap = {}
