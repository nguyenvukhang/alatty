...
def alatty_main(called_from_panel: bool = False) -> None:
    ...
    if getattr(sys, 'cmdline_args_for_open', False):
        ...
        if not called_from_panel:
            cli_flags = getattr(sys, 'alatty_run_data', {}).get('cli_flags', None)
