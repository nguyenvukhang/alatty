...
as the :doc:`panel kitten </kittens/panel>`, except for :option:`--override <alatty +kitten panel --override>`
and :option:`--config <alatty +kitten panel --config>`. Can be specified multiple times.
