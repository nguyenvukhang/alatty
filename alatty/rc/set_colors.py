...
''' + '\n\n' + MATCH_WINDOW_OPTION + '\n\n' + MATCH_TAB_OPTION.replace('--match -m', '--match-tab -t')
    ...
    def message_to_alatty(self, global_opts: RCOptions, opts: 'CLIOptions', args: ArgsType) -> PayloadType:
        ...
        from alatty.colors import parse_colors
        if not opts.reset:
            try:
    ...
    def response_from_alatty(self, boss: Boss, window: Window | None, payload_get: PayloadGetType) -> ResponseType:
        from alatty.colors import patch_colors
