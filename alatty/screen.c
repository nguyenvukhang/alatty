...
screen_modify_other_keys(Screen *self, unsigned val, unsigned val2) {
    // Only report an error about modifyOtherKeys if the alatty keyboard
    ...
    if (
        ...
        log_error("The application is trying to use xterm's modifyOtherKeys. This is superseded by the alatty keyboard protocol https://sw.kovidgoyal.net/alatty/keyboard-protocol. The application should be updated to use that.");
    }
}
